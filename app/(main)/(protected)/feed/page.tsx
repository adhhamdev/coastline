...
import { Home, Bell, Mail, User, MoreHorizontal, AlertCircle } from "lucide-react"
...
export default async function FeedPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="mx-auto grid grid-cols-1 md:grid-cols-[auto,1fr] lg:grid-cols-[250px,1fr,350px] gap-4 p-4">
                            ...
                            <div className="space-y-4">
                                {Array.from({ length: 5 }).map((_, i) => (
                                    <div key={i} className="space-y-1">
                                        <p className="text-sm text-muted-foreground">Trending in Tech</p>
